...
<div class="container">
    <h2 class="text-center">Modificar calificaciones</h2>
    ...
    <div class="row" style="margin-top:40px;">
      ...
      <div class="col-xs-12 col-sm-4	col-md-4	col-lg-4 ">
        ...
        <div class="col-sm-12">
          <select class="form-control" name="carrera" id="selectMat"></select>
        </div>
      </div>
      <div class="col-xs-12 col-sm-3	col-md-3	col-lg-3 ">
        <label  class="col-sm-12 control-label">letra Grupo</label>
        <div class="col-sm-12">
          <select class="form-control" name="carrera" id="selectLetra"></select>
        </div>
      </div>
    ...
    <div class="table-responsive divTable" style="margin-top:60px;display:none;margin-bottom:40px;">
      ...
      <div class="col-md-12">
        <button type="button" class="btn btn-primary pull-right" name="button" id="modificar">Modificar Calificaciones</button>
      </div>
    </div>
...
<script src="{!!URL::asset('/js/app/modificarCalif.js')!!}" charset="utf-8"></script>
@stop
