...
{{-- <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"> --}}
  <div class="container">
    <h2 class="text-center">Asignar maestros para el curso de inducción</h2>
    ...
    <div class="alerts">
    <div class="alert alert-success text-center alExito" role="alert"><strong>Éxito!</strong> Los Maestros fueron asignados correctamente</div>
    ...
    <link rel="stylesheet" href="{!!URL::asset('css/app/asignarMaestros.css')!!}">
    <script src="{!!URL::asset('/js/jquery-ui.js')!!}" charset="utf-8"></script>
    {{-- <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> --}}
    <script src="{!!URL::asset('/js/app/asignarMaestros.js')!!}" charset="utf-8"></script>
@stop
